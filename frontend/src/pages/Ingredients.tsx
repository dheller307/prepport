  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = isEditing
        ? await updateIngredient(editingIngredient.id!, form)
      ...
      {isFormOpen && (
        <form className="entity-form" onSubmit={handleSubmit}>
          ...
          <div className="form-field">
            ...
            <select
              id="macroBasis"
              value={form.macroBasis}
              onChange={(e) =>
                setForm({
                  ...form,
                  macroBasis: e.target.value as "RAW" | "COOKED",
                })
              }
            >
            ...
            <p className="hint">
              Use raw unless you copied numbers from a cooked food or a package
              label. Batches still need raw and cooked weights for yield.
            </p>
          </div>
          <div className="form-field">
            ...
            <input
              ...
              step="0.1"
              placeholder="0"
              value={form.proteinPer100g === 0 ? "" : form.proteinPer100g}
              onChange={(e) =>
          ...
          <div className="form-field">
            ...
            <input
              ...
              step="0.1"
              placeholder="0"
              value={form.carbsPer100g === 0 ? "" : form.carbsPer100g}
              onChange={(e) =>
          ...
          <div className="form-field">
            ...
            <input
              ...
              step="0.1"
              placeholder="0"
              value={form.fatPer100g === 0 ? "" : form.fatPer100g}
              onChange={(e) =>
          ...
          <div className="form-field">
            ...
            <input
              ...
              step="0.1"
              placeholder="0"
              value={form.kcalPer100g === 0 ? "" : form.kcalPer100g}
              onChange={(e) =>
                setForm({ ...form, kcalPer100g: Number(e.target.value) })
              }
            />
          </div>
          <div className="form-field">
