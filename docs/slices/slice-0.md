...
Done when:
- [ ] `yieldRatio(2146, 1600)` ≈ `0.746` (cooked ÷ raw)
- [ ] `rawEquivalentG(200, 2146, 1600)` ≈ `268` g (Cronometer raw weight for a cooked scoop)
- [ ] `proteinForCookedPortion(200, 2146, 1600, 31.0)` ≈ `83` g (31 g protein / 100 g raw)
- [ ] JUnit suite green via `./mvnw test` from `backend/`
- [ ] Chicken scenario documented as a comment or `@DisplayName` in the test class
